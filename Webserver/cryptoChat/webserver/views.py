...
def send_emergency_message(name,number,receiver):
...
@csrf_exempt
def reset(request):
    global send,threshold_value,blocked
...
def send_message(request):
    global send
    global threshold_value, threshold_limit,blocked
    if request.method == 'POST':
        message = request.POST.get("message")
        '''
